...
internal sealed class CaptureSampleConverter
{
    ...
    public int ConvertAndWrite(byte[] source, int bytesRecorded, BoundedFrameAdapter destination, out int droppedSamples)
    {
    ...
    private float ReadSample(byte[] source, int offset)
    {
    ...
    private static int ReadInt24(byte[] source, int offset)
    {

import { F as require_react, L as __toESM, N as require_jsx_runtime, k as createLucideIcon, t as switchboardApi } from "./demo-api-BNokT5Mf.js";
import { t as Check } from "./check-8nSVBn45.js";
import { J as Button, St as FolderOpen, V as Separator, W as Progress, c as Dialog, d as DialogHeader, f as DialogTitle, i as formatDuration, l as DialogContent, n as formatBytes, p as DialogTrigger, st as Video, u as DialogDescription } from "./index-Br7Ix8br.js";
import { n as ToggleGroup, r as ToggleGroupItem } from "./badge-C5CRduJA.js";
import { v as Share2 } from "./capture-BuauTlX_.js";
/**
...
function ShareClipDialog({ clip, startMs, endMs, exportPending, disabled = false, projectType = "single", segmentCount = 1, sourceBytes, selectedDurationMs, onExport, onCancelExport }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
			...
			className: "max-w-[520px] overflow-hidden p-0 no-drag",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [!thumbnailFailed && clip.thumbnailPath ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									onClick: () => void switchboardApi.revealPreparedShareFile(prepared.id).catch((cause) => setError(errorMessage(cause))),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: prepared ? `${formatBytes(prepared.fileSize)} · Ready to drag` : selected.targetBytes ? `Up to ${selected.label}` : `About ${formatBytes(expectedBytes)}`
						})]
						...
						onClick: () => void cancelExport().catch((cause) => setError(errorMessage(cause))),
						children: "Cancel"
...
//#endregion
export { PanelRightClose as a, PanelRightOpen as i, Undo2 as n, Minimize as o, Scissors as r, Maximize as s, ShareClipDialog as t };

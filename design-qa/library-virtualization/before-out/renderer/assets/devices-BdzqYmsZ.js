const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./MicrophoneDeviceEditor-BZkTnGLo.js","./demo-api-WdKuQJz2.js","./tooltip-DiXKon0p.js","./index-DUNxodKI.js","./check-oJKBko3B.js","./index-TfRLGA3a.css","./toggle-group-CcsUT_gm.js","./equipment-workbench-Cdbd2Kuc.css","./KeyboardDeviceEditor-BxcYQbpq.js","./popover-D-tY7V_8.js","./ColorPicker-EZStrh-5.js","./MouseDeviceEditor-B1pcv2jW.js","./dist-DwsPwt3N.js","./trash-2-DaPFSLcX.js","./context-menu-Csq9A3YO.js","./MouseDeviceEditor-Djs3MzQd.css"])))=>i.map(i=>d[i]);
import { E as __toESM, S as require_jsx_runtime, _ as cn, v as createLucideIcon, w as require_react } from "./demo-api-WdKuQJz2.js";
import { n as TooltipContent, r as TooltipTrigger, t as Tooltip } from "./tooltip-DiXKon0p.js";
import { t as MicVocal } from "./mic-vocal-UyAgoy2F.js";
import { Ft as Keyboard, Gt as ArrowRight, Kt as ArrowLeft, Nt as Mouse, Wt as Blocks, t as __vitePreload, wt as Usb, z as useSystemStore } from "./index-DUNxodKI.js";
import { t as Skeleton } from "./skeleton-Cy2v75H0.js";
	...
	(0, import_react.useEffect)(() => {
		...
		image.onload = () => {
			...
			try {
				...
				if (artwork.lightingMask === "photographic-rgb") mattePhotographicBackdrop(pixels.data, canvas.width, canvas.height);
...
var MicrophoneDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./MicrophoneDeviceEditor-BZkTnGLo.js").then((module) => ({ default: module.MicrophoneDeviceEditor })), __vite__mapDeps([0,1,2,3,4,5,6,7]), import.meta.url));
var KeyboardDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./KeyboardDeviceEditor-BxcYQbpq.js").then((module) => ({ default: module.KeyboardDeviceEditor })), __vite__mapDeps([8,1,2,3,4,5,9,6,10,7]), import.meta.url));
var MouseDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./MouseDeviceEditor-B1pcv2jW.js").then((module) => ({ default: module.MouseDeviceEditor })), __vite__mapDeps([11,1,2,4,12,3,5,9,13,14,6,10,15]), import.meta.url));

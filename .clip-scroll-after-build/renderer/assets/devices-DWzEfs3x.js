const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./MicrophoneDeviceEditor-IQnbkaXT.js","./demo-api-Ce3WgRJZ.js","./tooltip-Dzg1fQmA.js","./index-DsMpX2W2.js","./index-BaCREv9l.css","./toggle-group-CLDUs4Nx.js","./equipment-workbench-Cdbd2Kuc.css","./KeyboardDeviceEditor-BSt7GtYH.js","./popover-B57WxhxV.js","./ColorPicker-BFM0EC3s.js","./KeyboardDeviceEditor-fyNdXUhb.css","./MouseDeviceEditor-D6jAV_oK.js","./dist-wYTmzoNe.js","./context-menu-V85eo6ud.js","./MouseDeviceEditor-CYya_4yA.css"])))=>i.map(i=>d[i]);
...
import { It as Keyboard, Jt as ArrowRight, Nt as Mouse, R as useSystemStore, St as Usb, Yt as ArrowLeft, qt as Blocks, t as __vitePreload } from "./index-DsMpX2W2.js";
import { t as Skeleton } from "./skeleton-F7m2Da_X.js";
...
function mattePhotographicBackdrop(data, width, height) {
...
function applyPhotographicLighting(data, target, intensity) {
	...
	for (let offset = 0; offset < data.length; offset += 4) {
		...
		const neutralValue = minimum + chroma * .1;
...
function applyG502Lighting(data, target, intensity) {
	...
	for (let offset = 0; offset < data.length; offset += 4) {
		...
		const neutralValue = minimum + chroma * .1;
		const output = mixColor({
			red: neutralValue,
			green: neutralValue,
			blue: neutralValue
		}, mixColor(source, colorized, maskStrength), intensity);
		data[offset] = Math.round(output.red);
		data[offset + 1] = Math.round(output.green);
		data[offset + 2] = Math.round(output.blue);
	}
	...
	(0, import_react.useEffect)(() => {
		...
		image.onload = () => {
			...
			if (artwork.lightingMask === "photographic-rgb") {
				const x = (value) => (value / 1500 * image.naturalWidth - crop.left) * processingScale;
				const y = (value) => (value / 1e3 * image.naturalHeight - crop.top) * processingScale;
				const w = (value) => value / 1500 * image.naturalWidth * processingScale;
				const h = (value) => value / 1e3 * image.naturalHeight * processingScale;
				context.beginPath();
			...
			try {
				...
				if (artwork.lightingMask === "photographic-rgb") {
					const cableRows = Math.max(0, Math.min(canvas.height, Math.floor((217 / 1e3 * image.naturalHeight - crop.top) * processingScale)));
					if (cableRows > 0) mattePhotographicBackdrop(pixels.data.subarray(0, canvas.width * cableRows * 4), canvas.width, cableRows);
				}
				...
				if (artwork.toneProfile === "black-hardware-on-dark" || artwork.toneProfile === "black-hardware-on-dark-when-unlit" && (!lighting.enabled || lighting.brightness <= 0)) adaptBlackHardwareForDarkSurface(pixels.data);
...
var MicrophoneDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./MicrophoneDeviceEditor-IQnbkaXT.js").then((module) => ({ default: module.MicrophoneDeviceEditor })), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url));
var KeyboardDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./KeyboardDeviceEditor-BSt7GtYH.js").then((module) => ({ default: module.KeyboardDeviceEditor })), __vite__mapDeps([7,1,2,3,4,8,5,9,10,6]), import.meta.url));
var MouseDeviceEditor = (0, import_react.lazy)(() => __vitePreload(() => import("./MouseDeviceEditor-D6jAV_oK.js").then((module) => ({ default: module.MouseDeviceEditor })), __vite__mapDeps([11,1,2,12,3,4,8,13,5,9,14]), import.meta.url));
function DevicesPage({ snapshot }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			}) : selected.kind === "mouse" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MouseDeviceEditor, { device: selected }) : selected.kind === "keyboard" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeyboardDeviceEditor, { device: selected }) : selected.kind === "microphone" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicrophoneDeviceEditor, {
				device: selected,
				snapshot

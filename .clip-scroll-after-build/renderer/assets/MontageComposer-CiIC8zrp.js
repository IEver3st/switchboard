...
import { i as Music2, r as Save, t as channelColor } from "./channel-identity-nlQQjHIM.js";
import { v as Pencil } from "./dist-wYTmzoNe.js";
import { At as Plus, B as Separator, Bt as Film, Dt as Search, Ht as Copy, I as Input, Kt as Check, L as ScrollArea, Mt as Pause, Yt as ArrowLeft, at as Checkbox, bt as Volume2, c as Dialog, d as DialogHeader, dt as SelectItem, f as DialogTitle, ft as SelectTrigger, i as formatDuration, j as Slider, jt as Play, l as DialogContent, lt as Select, n as formatBytes, p as DialogTrigger, pt as SelectValue, rt as Progress, s as formatVideoQuality, st as Button, u as DialogDescription, ut as SelectContent, wt as Trash2, xt as Video, yt as VolumeX, z as Switch, zt as FolderOpen } from "./index-DsMpX2W2.js";
...
function MontageV2Timeline({ playbackControls, previewControls, viewerFullscreen, project, clips, selectedSegmentId, currentMs, zoom, waveform, canUndo, canRedo, musicPending, onEditMusic, onEditAudio, onZoomChange, onProjectChange, onSelectSegment, onSeek, onAddClips, onAddMusic, onDuplicate, onSplit, onRemove, onUndo, onRedo }) {
	...
	const singleClip = project.sourceClipId ? clipsById.get(project.sourceClipId) : void 0;
	const [clipWaveform, setClipWaveform] = (0, import_react.useState)(null);
	const [audioError, setAudioError] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		setClipWaveform(null);
		setAudioError(false);
		if (!project.sourceClipId) return;
		let active = true;
		switchboardApi.loadClipAudioWaveform(project.sourceClipId).then((value) => {
			if (active) setClipWaveform(value);
		}).catch(() => {
	...
	}, [project.sourceClipId]);
	const audioTracks = clipWaveform && clipWaveform.clipId === project.sourceClipId ? clipWaveform.tracks : (singleClip?.audioChannels ?? []).map((channel, trackIndex) => ({
		trackIndex,
		channel,
		label: channel === "microphone" ? "Microphone" : channel[0].toUpperCase() + channel.slice(1),
		samples: []
	}));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		"aria-label": project.sourceClipId ? "Clip timeline" : "Montage timeline",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "montage-v2-timeline__toolbar no-drag",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						!project.sourceClipId ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							variant: "secondary",
							size: "sm",
							className: "montage-v2-add-clips",
							...
							children: [
								...
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Add clips" })
							]
						}) : null,
						project.sourceClipId ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							type: "button",
							...
							size: "sm",
							onClick: onEditAudio,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Volume2, { className: "size-3.5" }), "Audio channels"]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							type: "button",
							variant: "secondary",
							size: "sm",
				...
				playbackControls,
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "montage-v2-timeline__view-controls",
					children: [previewControls, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			"data-single": Boolean(project.sourceClipId),
			style: project.sourceClipId ? { height: 114 + laneCount * 48 } : void 0,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "montage-v2-lane-labels",
				style: project.sourceClipId ? { gridTemplateRows: `25px 88px repeat(${laneCount}, 48px)` } : void 0,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					project.sourceClipId ? audioTracks.length ? audioTracks.map((track) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "clip-channel-label",
						style: { "--track-color": channelColor(track.channel ?? "aux") },
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", { children: [
							track.label,
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("output", { children: [selected?.audioTrackLevels?.[track.trackIndex] ?? 100, "%"] })
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Slider, {
							min: 0,
							max: 100,
							step: 1,
							disabled: !selected,
							value: [selected?.audioTrackLevels?.[track.trackIndex] ?? 100],
							"aria-label": `${track.label} channel level`,
							onValueChange: ([level]) => {
								if (!selected || level === void 0) return;
								onProjectChange(updateMontageSegment(project, selected.id, (segment) => {
									const levels = [...segment.audioTrackLevels ?? []];
									while (levels.length <= track.trackIndex) levels.push(100);
									levels[track.trackIndex] = level;
									return {
										...segment,
										audioTrackLevels: levels
									};
								}), `segment:${selected.id}:track:${track.trackIndex}`);
							}
						})]
					}, track.trackIndex)) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Audio" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: audioStatus })] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Music" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: project.music ? "Imported audio" : "Empty lane" })] })
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: viewportRef,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineContextMenu, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						style: {
							width: `${width}px`,
							height: project.sourceClipId ? 113 + laneCount * 48 : void 0
						},
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							project.sourceClipId ? audioTracks.length ? audioTracks.map((track) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "clip-channel-lane",
								style: { "--track-color": channelColor(track.channel ?? "aux") },
								children: project.segments.map((segment) => {
									const start = montageStartForSegment(project.segments, segment.id);
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										className: "clip-channel-region",
										"data-segment-id": segment.id,
										"data-muted": segment.muted || segment.audioTrackLevels?.[track.trackIndex] === 0 || void 0,
										style: {
											left: start * pixelsPerMs,
											width: duration * pixelsPerMs
										},
										"aria-label": `Edit ${track.label} audio for ${clipsById.get(segment.clipId)?.name ?? "missing clip"}`,
										onClick: () => {
											onSelectSegment(segment.id);
											onEditAudio();
										},
										children: track.samples.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
											viewBox: `0 0 ${samples.length} 48`,
											preserveAspectRatio: "none",
											"aria-hidden": "true",
											children: samples.map((index) => {
										...
										}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: audioError ? "Waveform unavailable" : clipWaveform ? "No waveform data" : "Reading waveform…" })
									}, segment.id);
								})
							}, track.trackIndex)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "clip-channel-lane",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: audioStatus })
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						viewerFullscreen,
						playbackControls: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						previewControls: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										variant: "ghost",
										size: "sm",
										"aria-pressed": inspectorSection === "segment" && (!project.sourceClipId || editTool !== "audio"),
										onClick: () => {
											setInspectorSection("segment");
											if (project.sourceClipId) setEditTool("framing");
										},
										children: "Selected clip"
									}), project.sourceClipId ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										variant: "ghost",
										size: "sm",
										"aria-pressed": inspectorSection === "segment" && editTool === "audio",
										onClick: () => {
											setInspectorSection("segment");
											setEditTool("audio");
										},
								...
								inspectorSection === "segment" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: selectedSegment && selectedClip ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
											...
											open: project.sourceClipId && editTool === "audio" ? true : void 0,
											children: [
								...
								!project.sourceClipId && inspectorSection === "music" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {

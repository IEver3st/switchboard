...
GitHub Release publishing and end-user delivery are separate gates. The public repository provides an anonymously readable feed, but no release has been published yet and Windows installers remain unsigned. No GitHub credential is stored in settings, preload, or the renderer.

        ...
        <div className="flex flex-col gap-3 xl:flex-row xl:items-end">
          ...
          <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2 xl:justify-end">
            ...
            <div className="w-36 shrink-0">
              <SelectField value={gameFilter} onChange={setGameFilter} ariaLabel="Filter clips by game" options={[{ value: 'all', label: 'All games' }, ...games.map((game) => ({ value: game, label: game }))]} />
            </div>
            <div className="w-32 shrink-0">
              <SelectField value={sort} onChange={(value) => setSort(value as ClipSort)} ariaLabel="Sort clips" options={[{ value: 'newest', label: 'Newest' }, { value: 'oldest', label: 'Oldest' }, { value: 'largest', label: 'Largest' }, { value: 'smallest', label: 'Smallest' }, { value: 'longest', label: 'Longest' }]} />
            </div>
